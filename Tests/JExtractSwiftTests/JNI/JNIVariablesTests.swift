  ...
  func constant_swiftThunks() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyClass__00024getConstant__J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, selfPointer: jlong) -> jlong {
          ...
  ...
  func mutable_swiftThunks() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyClass__00024getMutable__J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, selfPointer: jlong) -> jlong {
        ...
        public func Java_com_example_swift_MyClass__00024setMutable__JJ(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, newValue: jlong, selfPointer: jlong) {
          assert(selfPointer != 0, "selfPointer memory address was null")
          ...
  ...
  func computed_swiftThunks() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyClass__00024getComputed__J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, selfPointer: jlong) -> jlong {
          ...
  ...
  func computedThrowing_swiftThunks() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyClass__00024getComputedThrowing__J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, selfPointer: jlong) -> jlong {
          ...
          do {
  ...
  func getterAndSetter_swiftThunks() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyClass__00024getGetterAndSetter__J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, selfPointer: jlong) -> jlong {
          ...
        ...
        public func Java_com_example_swift_MyClass__00024setGetterAndSetter__JJ(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, newValue: jlong, selfPointer: jlong) {
          ...
  ...
  func someBoolean_swiftThunks() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyClass__00024isSomeBoolean__J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, selfPointer: jlong) -> jboolean {
          ...
        ...
        public func Java_com_example_swift_MyClass__00024setSomeBoolean__ZJ(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, newValue: jboolean, selfPointer: jlong) {
          ...
  ...
  func isBoolean_swiftThunks() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyClass__00024isBoolean__J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, selfPointer: jlong) -> jboolean {
          ...
        ...
        public func Java_com_example_swift_MyClass__00024setBoolean__ZJ(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, newValue: jboolean, selfPointer: jlong) {
          ...
  ...
  func privateSetCounter_swiftThunks() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyClass__00024getPrivateSetCounter__J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, selfPointer: jlong) -> jlong {
          ...
