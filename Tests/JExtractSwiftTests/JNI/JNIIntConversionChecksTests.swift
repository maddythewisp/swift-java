  ...
  @Test func generatesInitWithSignedCheck() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyStruct__00024init__J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, normalInt: jlong) -> jlong {
  ...
  @Test func geberatesInitWithUnsignedCheck() throws {
    try assertOutput(
      ...
      expectedChunks: [
        """
        @_cdecl("Java_com_example_swift_MyStruct__00024init__J")
        public func Java_com_example_swift_MyStruct__00024init__J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, unsignedInt: jlong) -> jlong {
  ...
  @Test func generatesOptionalInitWithSignedCheck() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyStruct__00024init__BJ(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, optionalInt_discriminator: jbyte, optionalInt_value: jlong) -> jlong {
  ...
  @Test func generatesOptionalInitWithUnsignedCheck() throws {
    try assertOutput(
      ...
      expectedChunks: [
        """
        @_cdecl("Java_com_example_swift_MyStruct__00024init__BJ")
        public func Java_com_example_swift_MyStruct__00024init__BJ(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, optionalUInt_discriminator: jbyte, optionalUInt_value: jlong) -> jlong {
  ...
  @Test func generatesOptionalSignedGetterWithoutCheck() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyStruct__00024getOptionalInt__J_3B(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, selfPointer: jlong, result_discriminator$: CjbyteArray?) -> jlong {
        """,
        """
        let result$: jlong
  ...
  @Test func generatesOptionalUnsignedGetterWithoutCheck() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyStruct__00024getOptionalUInt__J_3B(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, selfPointer: jlong, result_discriminator$: CjbyteArray?) -> jlong {
        """,
        """
        let result$: jlong
  ...
  @Test func generatesUnsignedSetterWithCheck() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyStruct__00024setUnsignedInt__JJ(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, newValue: jlong, selfPointer: jlong) {
  ...
  @Test func generatesUnsignedGetterWithoutCheck() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyStruct__00024getUnsignedInt__J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, selfPointer: jlong) -> jlong {
          assert(selfPointer != 0, "selfPointer memory address was null")
          let selfPointerBits$ = Int(Int64(fromJNI: selfPointer, in: environment))
          let selfPointer$ = UnsafeMutablePointer<MyStruct>(bitPattern: selfPointerBits$)
          guard let selfPointer$ else {
  ...
  @Test func generatesSignedSetterWithCheck() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyStruct__00024setNormalInt__JJ(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, newValue: jlong, selfPointer: jlong) {
  ...
  @Test func generatesFuncWithSignedCheck() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyStruct__00024dummyFunc__JJ(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, arg: jlong, selfPointer: jlong) -> jlong {
  ...
  @Test func generatesEnumCaseWithUnsignedCheck() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyEnum__00024secondCase__J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, arg0: jlong) -> jlong {
