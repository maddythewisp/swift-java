  ...
  func initializer_swiftThunks() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyStruct__00024init__JJ(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, x: jlong, y: jlong) -> jlong {
  ...
  func memberMethod_swiftThunks() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_MyStruct__00024doSomething__JJ(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, x: jlong, selfPointer: jlong) {
