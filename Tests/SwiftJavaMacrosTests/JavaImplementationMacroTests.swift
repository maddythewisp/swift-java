  ...
  func testJNIIdentifierEscaping() throws {
    assertMacroExpansion(
      ...
      expandedSource: """
        ...
        public func __macro_local_22HelloWorld_test_methodfMu_(environment: UnsafeMutablePointer<CJNIEnv?>!, thisObj: jobject) -> Int32.JNIType {
  ...
  func testJNIIdentifierEscapingWithDots() throws {
    assertMacroExpansion(
      ...
      expandedSource: """
        ...
        public func __macro_local_20MyClass_simpleMethodfMu_(environment: UnsafeMutablePointer<CJNIEnv?>!, thisObj: jobject) -> Int32.JNIType {
  ...
  func testJNIIdentifierEscapingStaticMethod() throws {
    assertMacroExpansion(
      ...
      expandedSource: """
        ...
        public func __macro_local_19Utils_static_helperfMu_(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass) -> String.JNIType {
  ...
  func testJNIIdentifierEscapingMultipleMethods() throws {
    assertMacroExpansion(
      ...
      expandedSource: """
        ...
        public func __macro_local_31ClassWithUnderscores_method_onefMu_(environment: UnsafeMutablePointer<CJNIEnv?>!, thisObj: jobject) -> Int32.JNIType {
        ...
        public func __macro_local_31ClassWithUnderscores_method_twofMu_(environment: UnsafeMutablePointer<CJNIEnv?>!, thisObj: jobject) -> Int32.JNIType {
          let obj = ClassWithUnderscores(javaThis: thisObj, environment: environment!)
  ...
  func testJNIIdentifierEscapingWithJavaMethodNameOverride() throws {
    assertMacroExpansion(
      ...
      expandedSource: """
        ...
        public func __macro_local_28SwiftDictionaryMapJava__sizefMu_(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, pointer: Int64.JNIType) -> Int32.JNIType {
        ...
        public func __macro_local_31SwiftDictionaryMapJava__destroyfMu_(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, pointer: Int64.JNIType) {
  ...
  func testJNIIdentifierEscapingVoidReturn() throws {
    assertMacroExpansion(
      ...
      expandedSource: """
        ...
        public func __macro_local_22Processor_process_datafMu_(environment: UnsafeMutablePointer<CJNIEnv?>!, thisObj: jobject) {
