  ...
  func function_swiftThunks() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_SwiftModule__00024function__Ljava_lang_Long_2Ljava_lang_Integer_2J(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, javaLong: Cjobject?, javaInteger: Cjobject?, int: jlong) {
