  ...
  func nestedClassesAndStructs_swift() throws {
    try assertOutput(
      ...
      expectedChunks: [
        ...
        public func Java_com_example_swift_A__00024typeMetadataAddressDowncall__(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass) -> jlong {
          ...
        }
        """,
        """
        @_cdecl("Java_com_example_swift_A_00024B__00024typeMetadataAddressDowncall__")
        public func Java_com_example_swift_A_00024B__00024typeMetadataAddressDowncall__(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass) -> jlong {
          ...
        }
        """,
        """
        @_cdecl("Java_com_example_swift_A_00024B_00024C__00024typeMetadataAddressDowncall__")
        public func Java_com_example_swift_A_00024B_00024C__00024typeMetadataAddressDowncall__(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass) -> jlong {
          ...
        }
        """,
        """
        @_cdecl("Java_com_example_swift_A_00024B_00024C__00024h__JJ")
        public func Java_com_example_swift_A_00024B_00024C__00024h__JJ(environment: UnsafeMutablePointer<CJNIEnv?>!, thisClass: jclass, b: jlong, selfPointer: jlong) {
          ...
        }
        """,
      ]
